...
server:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py runserver $(port)
...
migrate:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py migrate

migrations:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py makemigrations
...
makemessages:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py makemessages -l en --ignore env*
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py makemessages -l fr --ignore env*

compilemessages:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py compilemessages -l en -l fr --ignore env*
...
shell:
	DJANGO_SETTINGS_MODULE=app.settings.$(setting) . env/bin/activate && python3.9 manage.py shell