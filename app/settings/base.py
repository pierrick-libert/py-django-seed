...
SECRET_KEY = os.environ.get("SECRET_KEY", "rand0m&k3yF0R-someus3")  # nosec pragma: allowlist secret
...
LOCALE_PATHS = (os.path.join(os.path.normpath(BASE_DIR + os.sep + os.pardir), "locale"),)
